...
class Database(object):
    ...
    @staticmethod
    def initialize(link="sqlite:///financial_db.sqlite"):  # Initializes Database (Mongodb must be already running on system)
        Database.engine = create_engine(link, echo=False)
